# Nexlayer — mattermost-playbooks

**Live:** [https://relaxed-weasel-mattermost-playbooks.cloud.nexlayer.ai](https://relaxed-weasel-mattermost-playbooks.cloud.nexlayer.ai)  
...
**mattermost-playbooks** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: mattermost-playbooks
  pods:
  - name: app
    image: mirror.gcr.io/mattermost/mattermost-team-edition:latest
    path: /
    servicePorts:
    - 8065
    vars:
      MM_SQLSETTINGS_DRIVERNAME: postgres
      MM_SQLSETTINGS_DATASOURCE: "postgres://mattermost:${POSTGRES_PASSWORD}@postgres.pod:5432/mattermost?sslmode=disable&connect_timeout=10"
      MM_SERVICESETTINGS_SITEURL: "https://relaxed-weasel-mattermost-playbooks.cloud.nexlayer.ai"
  - name: postgres
